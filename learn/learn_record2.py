...
n_train_data = int(board_num * (1.0 - test_ratio))
n_test_data = int(board_num * test_ratio)
...
'''
model = load_model('param/model_0928.h5')
model.summary()

test_num = int(board_num * test_ratio)
train_num = board_num - test_num
all_data = loaded_data[:train_num]
reshape_data_train()
all_data = loaded_data[train_num:board_num]
reshape_data_test()
my_evaluate.kill()
